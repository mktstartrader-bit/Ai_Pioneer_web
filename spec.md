...
问卷分为 **3 个 Section**，总计 32 题，预计耗时 30–40 分钟：

| Section | 主题 | 题数 | 题型 |
|---------|------|------|------|
| SECTION 1 | AI Fundamentals | 10 题 | 单选题 |
| SECTION 2 | AI Application & Business Thinking | 10 题 | 单选题 |
| SECTION 3 | Learning Motivation & Growth Potential | 12 题 | 单选题 + 开放题 |
...
CREATE TABLE public.applications (
  ...
  answers JSONB NOT NULL DEFAULT '{}'::jsonb,  -- 32 题答案
...
| `src/data/questions.ts` | 32 题问卷数据定义 |
...
2. **答案评分**: 对 28 道 MC 题自动评分，开放题人工评审
