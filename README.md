...
Landing page and 32-question assessment for STARTRADER's internal 2-month enterprise AI training program.
...
7. **Application Form** — Two-step: personal info (name / phone / company email validation) → 32-question assessment with sticky progress, explicit "Next Question" navigation, textarea character counters, and success screen.
